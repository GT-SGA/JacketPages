      ...
      <div id="content">
          <div className="clearfix">
              <div id="middle_full">
                  ...
                  <form action="http://localhost:8081/bill_create" onsubmit="return submitForm()" id="BillAddForm" accept-charset="utf-8">
                      {/* <div style="display:none;"><input name="_method" value="POST" type="hidden" /></div> */}
                      <div className="input text required"><label for="BillTitle">Title</label><input name="data_Bill_title" maxlength="60" id="BillTitle" required="required" type="text" /></div>
                      <div className="input textarea required"><label for="BillDescription">Description</label><textarea name="data_Bill_description" cols="30" rows="6" id="BillDescription" required="required"></textarea></div>
                      <div className="input textarea"><label for="BillFundraising">Fundraising - Please describe related fundraising efforts</label><textarea name="data_Bill_fundraising" cols="30" rows="6" id="BillFundraising"></textarea></div>
                      ...
                      <div className="multi_enter_line_items">
                          ...
                          <table className="listing" id="LineItemsTable">
                              <tbody>
                                  ...
                                  <tr>
                                      <td><input name="data_0_LineItem_id" value="" className="LineItemId" id="LineItemId0" type="hidden" /><input name="data_0_LineItem_line_number" value="1" className="LineItemNumber" id="LineItemLineNumber0" type="hidden" /><label for="0LineItemNumber" value="1" className="LineItemNumber" id="LineNumber0">1</label></td>
                                      <td><input name="data_0_LineItem_name" className="LineItemName" id="LineItemName0" type="text" /></td>
                                      <td><input name="data_0_LineItem_cost_per_unit" id="LineItemCostPerUnit0" className="LineItemCostPerUnit" onchange="updateTCAndRqstd(0)" type="text" /></td>
                                      <td><input name="data_0_LineItem_quantity" id="LineItemQuantity0" className="LineItemQuantity" onchange="updateTCAndRqstd(0)" type="text" /></td>
                                      <td><input name="data_0_LineItem_total_cost" id="LineItemTotalCost0" className="LineItemTotalCost" readonly="readonly" type="text" /></td>
                                      <td><input name="data_0_LineItem_amount" id="LineItemAmount0" className="LineItemAmount" type="text" /></td>
                                      <td>
                                      ...
                                      <td><button type="button" onclick="moveUp(0)"><img src="jpcreatebill_files/up.gif" alt="Move Up"></button></td>
